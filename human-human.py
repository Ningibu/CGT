...
player = input('Do you want to be hare or hounds, player1? ')
...
while flag == True:
    if turn == 0:
            if player == 'hare':
                ...
                row_to = int(input('Enter row,player1> '))
                col_to = int(input('Enter col,player1> '))
                ...
                if board[row_to][col_to] == 0:
                    ...
                    if is_legal_move(player, row_from, col_from, row_to, col_to):
                        ...
                        score = static_evaluation(board, player)
                        if is_gameover(board,score)==False:
                            print("Player1 Win")
                ...
                row_from = int(input('Enter row for hound you want to move, player1> '))
                col_from = int(input('Enter col for hound you want to move, player1> '))

                if board[row_from][col_from] == 1:
                    """Check if hound in that position and set to 0"""
                    row_to = int(input('Enter row where you want to place hound, player1> '))
                    col_to = int(input('Enter col where you want to place hound, player1> '))
            ...
            player2 = alternate_player(player)
            if player2 == 'hare':

                """Select moves for hare"""
                row_to = int(input('Enter row, player2> '))
                col_to = int(input('Enter col, player2> '))
                ...
                if board[row_to][col_to] == 0:
                    ...
                    """Set hare to new move"""
                    if is_legal_move(player2, row_from, col_from, row_to, col_to):
                        board[find_hare] = 0
                        board[row_to][col_to] = 2
                        print_game_state(board)
                        score = static_evaluation(board, player2)
                        if is_gameover(board,score)==False:
                            print("Player2 Win")
                ...
                """Select move for hounds"""
                row_from = int(input('Enter row for hound you want to move,player2> '))
                col_from = int(input('Enter col for hound you want to move, player2> '))

                if board[row_from][col_from] == 1:
                    """Check if hound in that position and set to 0"""
                    row_to = int(input('Enter row where you want to place hound,player2> '))
                    col_to = int(input('Enter col where you want to place hound, player2> '))
